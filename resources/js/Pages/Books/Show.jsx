...
export default function Show({ auth, book }) {
    ...
    const handleToggleRead = () => {
        router.patch(route('books.toggle-read', book.data.id));
    };
    ...
    return (
        ...
        >
                                ...
                                <div className="md:col-span-1">
                                    <div className="sticky top-6">
                                        ...
                                        <div className="mt-6 space-y-3">
                                            ...
                                            >
                                                {book.data.is_read ? 'Mark as Unread' : 'Mark as Read'}
                                            </button>
                                            <Link
                                ...
                                <div className="md:col-span-2 space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-2 text-xl text-gray-600 dark:text-gray-400">
                                            by {book.data.author.name || 'Unknown Author'}
                                        </p>
                                    </div>
                                    ...
                                    {book.data.rating && (
                                        <div>
                                            ...
                                            <StarRating rating={book.data.rating} readonly size="lg" />
                                        </div>
                                    )}
                                    ...
                                    <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
                                        <div className="grid grid-cols-2 gap-4 text-sm">
                                            ...
                                            <div>
                                                ...
                                                <span className="ml-2 text-gray-900 dark:text-white">
                                                    {new Date(book.data.updated_at).toLocaleDateString()}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
            ...
            <ConfirmationModal
                ...
                title="Delete Book"
                message={`Are you sure you want to delete "${book.data.title}"? This action cannot be undone.`}
                confirmText="Delete"
